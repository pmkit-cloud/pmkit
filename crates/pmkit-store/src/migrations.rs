use crate::{
    ...
    schema::{
        ...
        MIGRATE_PM_ENVELOPES_V2_TO_V3, MIGRATE_PM_ENVELOPES_V3_TO_V4, RECORD_SCHEMA_MIGRATION,
        SCHEMA,
    },
};
...
const _: () = assert!(CURRENT_SCHEMA_VERSION == PM_ENVELOPE_V4_MIGRATION.version);
