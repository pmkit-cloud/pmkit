use crate::{
    ...
    schema::{
        ...
        MIGRATE_CAUSAL_DECISIONS_V1_TO_V2, MIGRATE_PM_ENVELOPES_V1_TO_V2, RECORD_SCHEMA_MIGRATION,
        SCHEMA,
    },
};
...
const _: () = assert!(CURRENT_SCHEMA_VERSION == CAUSAL_DECISION_V2_MIGRATION.version);
