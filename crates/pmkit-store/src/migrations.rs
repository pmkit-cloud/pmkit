use crate::{
    StoreError,
    schema::{
        CREATE_CLOUD_MATERIALIZATIONS, CREATE_FINALIZED_CHAIN_CHECKPOINTS,
        CREATE_PUBLIC_TAPE_EVIDENCE, CREATE_SCHEMA_MIGRATIONS, CURRENT_SCHEMA_VERSION,
        ...
        MIGRATE_PM_ENVELOPES_V4_TO_V5, MIGRATE_PM_ENVELOPES_V5_TO_V6, MIGRATE_REPLAY_GAPS_V1_TO_V2,
        RECORD_SCHEMA_MIGRATION, SCHEMA,
    },
};
...
const PUBLIC_TAPE_EVIDENCE_MIGRATION: Migration =
    Migration::new(10, &[CREATE_PUBLIC_TAPE_EVIDENCE]);

const CLOUD_MATERIALIZATION_MIGRATION: Migration =
    Migration::new(11, &[CREATE_CLOUD_MATERIALIZATIONS]);

const REPLAY_GAP_SNAPSHOT_MIGRATION: Migration = Migration::new(12, MIGRATE_REPLAY_GAPS_V1_TO_V2);

const _: () = assert!(CURRENT_SCHEMA_VERSION == REPLAY_GAP_SNAPSHOT_MIGRATION.version);
...
pub const MIGRATIONS: &[Migration] = &[
    ...
    PUBLIC_TAPE_EVIDENCE_MIGRATION,
    CLOUD_MATERIALIZATION_MIGRATION,
    REPLAY_GAP_SNAPSHOT_MIGRATION,
];
